package com.satish.kappera.library.test;
...
import com.satish.kappera.developer.library.LibraryApplication;
import com.satish.kappera.developer.library.model.Book;
import com.satish.kappera.developer.library.service.BookServiceImpl;
			...
			Thread thread = new Thread(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						book.setName("Satish Love Story");
